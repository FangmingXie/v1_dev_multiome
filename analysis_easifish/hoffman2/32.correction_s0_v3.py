...
path = "/u/home/f/f7xiesnm/project-zipursky/data/00_tiled/sparse06_r1.n5"
outpath = "/u/home/f/f7xiesnm/project-zipursky/data/hold/sparse06/r1_test_flatfield_v9.n5"
...
i_s = np.array([18]) # np.arange(0, 20, 1) # c0
# i_s = np.arange(40, 60, 1) # c2
...
for setup in setups: 
    # add setup level attributes to conform to bdv.n5 format
    setup_handle  = n5_root.require_group(f'{setup}')
    setup_attrs = setup_handle.attrs.asdict()
    setup_attrs['downsamplingFactors'] = [[1,1,1],[2,2,1]]
