...
path    = "/u/home/f/f7xiesnm/project-zipursky/data/00_tiled/273LU_aldh1l1Cre_Pcdhg_homo.n5"
outpath = "/u/home/f/f7xiesnm/project-zipursky/data/02_flat/273LU_aldh1l1Cre_Pcdhg_homo_autos1_flat.n5"
num_tiles = 12 # 7 FOVs
num_channels = 5
num_setups = num_tiles*num_channels 
# check if timepoint = setup % num_tiles or +1

scale   = 's0' # 's1' #'s0'
upscale = 8 # 8    # 16 - linear
# scale   = 's3' #'s0'
# upscale = 2    # 16 - linear
...
for setup_idx in i_s: 
    ...
    ### !!!! this is very special for this particular data !!!!!
    timepoint = setup_idx % num_tiles
    slot = f'/setup{setup_idx}/timepoint{timepoint}/{scale}'
    ### !!!! this is very special for this particular data !!!!!
    logging.info(slot)
